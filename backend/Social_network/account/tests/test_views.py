...
class AccountViewTest(TestCase):
    ...
    def test_account_edit_avatar(self):
        response = self.client.post('/api/v1/account/edit/avatar/',
                                    data={'avatar': '',
                                          },
                                    content_type="application/json")
    ...
    def test_account_work_delete(self):
        response = self.client.delete('/api/v1/account/edit/work/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        response = self.client.get('/api/v1/account/edit/work/1/')
    ...
    def test_account_education_create(self):
        response = self.client.post('/api/v1/account/edit/education/',
                                    data={'name': 'school',
                                          'city': '',
                                          'status': '',
                                          'level': '',
    ...
    def test_account_education_delete(self):
        self.client.delete('/api/v1/account/edit/education/1/')

        response = self.client.get('/api/v1/account/edit/education/1/')
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
