...
class ChatViewTest(TestCase):
    ...
    def test_chat_create(self):
        ...
        response = self.client.post('/v1/chat/',
                                    data={'name': 'my_chat',
                                          'open_or_close': True,
    ...
    def test_chat_edit(self):
        ...
        response = self.client.patch('/v1/chat/1/',
                                     data={'name': 'my_chat1',
                                           'open_or_close': False,
    ...
    def test_chat_delete(self):
        response = self.client.delete('/v1/chat/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_messages_chat(self):
        response = self.client.get('/v1/chat/messages/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_messages_message_mock_chat(self):
        ...
        response = self.client.get('/v1/chat/messages_mock/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        # прикрепляем к нему фото
        response = self.client.put('/v1/chat/messages_mock/1/',
        ...
        response = self.client.put('/v1/chat/messages/1/',
                                   data={'text': fake.text()},
                                   content_type="application/json")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_dialog(self):
        response = self.client.get('/v1/chat/dialogs/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 1)

    def test_dialog_create_already_exist(self):

        response = self.client.post('/v1/chat/dialogs/',
                                    data={'status': 'friend',
    ...
    def test_dialog_edit(self):
        response = self.client.patch('/v1/chat/dialogs/1/',
                                     data={'status': 'enemy'
                                           },
                                     content_type="application/json")
    ...
    def test_dialog_delete(self):
        response = self.client.delete('/v1/chat/dialogs/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data, 'Отношения успешно удалены')

        response = self.client.get('/v1/chat/dialogs/1/')
    ...
    def test_messages_dialog(self):
        response = self.client.get('/v1/chat/dialogs/messages/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(len(response.data), 3)
    ...
    def test_messages_message_mock_dialog(self):
        # создаем mock сообщения (неотправленное)
        response = self.client.get('/v1/chat/dialogs/messages_mock/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)

        # прикрепляем к нему фото
        response = self.client.put('/v1/chat/dialogs/messages_mock/1/',
                                   data={'photo': list(self.get_photos())},
                                   content_type="application/json")
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data, 'Фото добавлены к сообщению')
        ...
        response = self.client.put('/v1/chat/dialogs/messages/1/',
                                   data={'text': fake.text()},
                                   content_type="application/json")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
    ...
    def test_message(self):
        ...
        response = self.client.patch('/v1/chat/message/1/',
                                     data={'text': fake.text(),
    ...
    def test_message_delete(self):
        response = self.client.delete('/v1/chat/message/1/')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
