...
class LoginViewTest(TestCase):
    ...
    def test_account_create_already_exist(self):
        response = self.client.post('/v1/login/register/',
    ...
    def test_auth_test_user(self):
        response = self.client.post('/v1/login/auth/',
    ...
    def test_register_try(self):
        response = self.client.post('/v1/login/register_try/',
                                    data={'email': 'user1@mail.ru'},
                                    content_type="application/json")
    ...
    def test_logout(self):
        ...
        response = self.client.post('/v1/login/logout/')
    ...
    def test_delete_account(self):
        ...
        response = self.client.delete('/v1/login/delete/')
